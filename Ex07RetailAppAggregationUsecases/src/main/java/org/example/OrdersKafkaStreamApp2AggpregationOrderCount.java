...
import static org.example.topology.OrdersApp2AggregationOrderCountTopology.*;


@Slf4j
public class OrdersKafkaStreamApp2AggpregationOrderCount {


    public static void main(String[] args) {

        // create an instance of the topology
        var topology = OrdersApp2AggregationOrderCountTopology.buildTopology();
