...
import static org.example.topology.Ex01DefaultExceptionHandlingTopology.*;

@Slf4j
public class Ex04CustomDeserializationExceptionHandlerWith2StreamThreads {
    ...
    public static void main(String[] args) {
        ...
        properties.put(StreamsConfig.DEFAULT_DESERIALIZATION_EXCEPTION_HANDLER_CLASS_CONFIG, StreamsDeserializationExcetionHandler.class);
