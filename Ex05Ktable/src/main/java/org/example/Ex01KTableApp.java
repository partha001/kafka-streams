...
import org.example.topology.Ex01KTableToplogy;

import java.util.List;
import java.util.Properties;
import java.util.stream.Collectors;

import static org.example.topology.Ex01KTableToplogy.WORDS;

@Slf4j
public class Ex01KTableApp {


    public static void main(String[] args) {

        var kTableTopology = Ex01KTableToplogy.build();
