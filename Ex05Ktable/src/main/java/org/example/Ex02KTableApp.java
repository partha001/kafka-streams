...
import org.example.topology.Ex02KTableToplogy;

import java.util.List;
import java.util.Properties;
import java.util.stream.Collectors;

import static org.example.topology.Ex02KTableToplogy.WORDS;

@Slf4j
public class Ex02KTableApp {


    public static void main(String[] args) {

        var kTableTopology = Ex02KTableToplogy.build();
