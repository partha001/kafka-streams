...
import org.example.topology.Ex07GreetingsTopologyWithPeekOperatorTopology;
...
@Slf4j
public class Ex07GreetingsStreamAppPeekOperatorLauncher {
    ...
    public static void main(String[] args) {
        ...
        createTopics(properties, List.of(Ex07GreetingsTopologyWithPeekOperatorTopology.GREETINGS, Ex07GreetingsTopologyWithPeekOperatorTopology.GREETINGS_UPPERCASE));

        // here are actaully initiating our topology
        var greetingTopology = Ex07GreetingsTopologyWithPeekOperatorTopology.buildTopoloogy();
