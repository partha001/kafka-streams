...
import org.example.topology.Ex03GreetingsTopologyWithFilterNot;
...
@Slf4j
public class Ex03GreetingsStreamAppFilterNotOperator {
    ...
    public static void main(String[] args) {
        ...
        createTopics(properties, List.of(Ex03GreetingsTopologyWithFilterNot.GREETINGS, Ex03GreetingsTopologyWithFilterNot.GREETINGS_UPPERCASE));

        // here are actaully initiating our topology
        var greetingTopology = Ex03GreetingsTopologyWithFilterNot.buildTopoloogy();
