...
import org.example.topology.Ex05GreetingsTopologyWithFlatMapOperatorTopology;
...
@Slf4j
public class Ex05GreetingsStreamAppFlatMapOperatorLauncher {
    ...
    public static void main(String[] args) {
        ...
        createTopics(properties, List.of(Ex05GreetingsTopologyWithFlatMapOperatorTopology.GREETINGS, Ex05GreetingsTopologyWithFlatMapOperatorTopology.GREETINGS_UPPERCASE));

        // here are actaully initiating our topology
        var greetingTopology = Ex05GreetingsTopologyWithFlatMapOperatorTopology.buildTopoloogy();
