...
import org.example.topology.Ex06GreetingsTopologyWithFlatMapValuesOperatorTopology;
...
@Slf4j
public class Ex06GreetingsStreamAppFlatMapValuesOperatorLauncher {
    ...
    public static void main(String[] args) {
        ...
        createTopics(properties, List.of(Ex06GreetingsTopologyWithFlatMapValuesOperatorTopology.GREETINGS, Ex06GreetingsTopologyWithFlatMapValuesOperatorTopology.GREETINGS_UPPERCASE));

        // here are actaully initiating our topology
        var greetingTopology = Ex06GreetingsTopologyWithFlatMapValuesOperatorTopology.buildTopoloogy();
