...
import org.example.topology.Ex02GreetingsTopologyWithFilter;
...
@Slf4j
public class Ex02GreetingsStreamAppFilterOperator {
    ...
    public static void main(String[] args) {
        ...
        createTopics(properties, List.of(Ex02GreetingsTopologyWithFilter.GREETINGS, Ex02GreetingsTopologyWithFilter.GREETINGS_UPPERCASE));

        // here are actaully initiating our topology
        var greetingTopology = Ex02GreetingsTopologyWithFilter.buildTopoloogy();
