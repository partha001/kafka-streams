...
import org.example.topology.Ex04AggregationAggregateOperatorTopology;
...
import static org.example.topology.Ex04AggregationAggregateOperatorTopology.AGGREGATE;

@Slf4j
public class Ex04AggregateAppLauncher {

    public static void main(String[] args) {

        var kTableTopology =  Ex04AggregationAggregateOperatorTopology.build();
