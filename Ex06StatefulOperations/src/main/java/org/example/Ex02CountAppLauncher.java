...
import org.example.topology.Ex02AggregationCountOperatorTopology;
...
import static org.example.topology.Ex02AggregationCountOperatorTopology.AGGREGATE;

@Slf4j
public class Ex02CountAppLauncher {

    public static void main(String[] args) {

        var kTableTopology = Ex02AggregationCountOperatorTopology.build();
