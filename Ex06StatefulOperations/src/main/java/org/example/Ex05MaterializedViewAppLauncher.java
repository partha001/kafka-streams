...
import org.example.topology.Ex05MaterializedViewTopology;
...
import static org.example.topology.Ex05MaterializedViewTopology.AGGREGATE;

@Slf4j
public class Ex05MaterializedViewAppLauncher {

    public static void main(String[] args) {

        var kTableTopology =  Ex05MaterializedViewTopology.build();
