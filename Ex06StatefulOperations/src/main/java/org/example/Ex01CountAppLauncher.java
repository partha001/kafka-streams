...
import org.example.topology.Ex01AggregationCountOperatorTopology;
...
import static org.example.topology.Ex01AggregationCountOperatorTopology.AGGREGATE;

@Slf4j
public class Ex01CountAppLauncher {

    public static void main(String[] args) {

        var kTableTopology = Ex01AggregationCountOperatorTopology.build();
