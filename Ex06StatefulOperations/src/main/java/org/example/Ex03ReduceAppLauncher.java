...
import org.example.topology.Ex03AggregationReduceOperatorTopology;
...
import static org.example.topology.Ex03AggregationReduceOperatorTopology.AGGREGATE;

@Slf4j
public class Ex03ReduceAppLauncher {

    public static void main(String[] args) {

        var kTableTopology =  Ex03AggregationReduceOperatorTopology.build();
